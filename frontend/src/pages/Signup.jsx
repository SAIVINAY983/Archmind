...
import { Layout, Mail, Lock, User, LifeBuoy } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        ...
        <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-emerald-500/10 blur-[60px] rounded-full pointer-events-none"></div>
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-400">Create your account to start designing</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          ...
          <Link to="/login" className="text-primary-400 hover:text-primary-300 transition-all">
            Log in
          </Link>
        </p>
      </motion.div>
